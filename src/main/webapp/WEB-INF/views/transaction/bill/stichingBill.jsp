...
<c:url var="addItemInBillList" value="/addItemInStitchingBillList" />
<c:url var="deleteItemFromBillDetail"
	value="/deleteItemFromStitchingBillDetail" />
</head>
			...
			<div class="body" ng-controller="billController">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
						...
						<div class="card">
							<div class="header">
								<h6 class="card-inside-title">GENERATE STICHING BILL</h6>
							</div>
						</div>
					</div>
				</div>
				<form id="submitForm"
					action="${pageContext.request.contextPath}/submitStitchingBill"
...
<script type="text/javascript">
	...
	function addItemInBillList() {
		...
		var amt = $("#amt").val();
		var stichingamt = $("#stichingamt").val();
		...
		if (itemId == "" || itemId == 0) {
			alert("Select Item");
			flag = 0;
		} else if (itemDesc == "" || itemDesc == null) {
			alert("Enter Item Description");
			flag = 0;
		} else if (isNaN(itemQty) || itemQty < 1 || itemQty == "") {
			alert("Enter valid Qty");
			flag = 0;
		} else if (isNaN(amt) || amt < 1 || amt == "") {
			alert("Enter valid Amt");
			flag = 0;
		} else if (isNaN(stichingamt) || stichingamt == "") {
			stichingamt = 0;
		}
	...
	function deleteItem(key) {
...

		{
			...
			$.each(data, function(key, itemList) {
				...
				tr.append($('<td align="right"></td>').html(
						itemList.stitchingAmt.toFixed(2)));
				tr.append($('<td align="right"></td>').html(
