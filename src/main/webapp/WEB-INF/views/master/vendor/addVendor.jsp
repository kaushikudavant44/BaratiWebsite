									...
									<div class="row clearfix">
										...
										<div class="col-md-4">
											...
											<div class="input-group spinner" data-trigger="spinner">
												<div class="form-line">
													<input type="text" class="form-control text-center"
														ng-model="gstNumber" id="gstNumber" >
												</div>
												<!-- <span class="input-group-addon"> <a
													href="javascript:;" class="spin-up" data-spin="up"><i
														class="glyphicon glyphicon-chevron-up"></i></a> <a
									...
									<table id="jobListTable"
										...
										<thead>
											<tr>
												...
												<th>Graduity</th>
												<th>Mediclaim</th>
												<th>Grade Gross Salary</th>
												<th>Grade Net Salary</th>
										...
										<tbody>
											<tr ng-repeat="pay in payScale">

												<td>{{ pay.jobName }}</td>
												<td>{{ pay.gradeBasic }}</td>
												<td>{{ pay.gradeTa }}</td>
												<td>{{ pay.gradeHra }}</td>
												<td>{{ pay.gradeBonus }}</td>
												<td>{{ pay.gradeOther }}</td>
												<td>{{ pay.gradePf }}</td>
												<td>{{ pay.gradePt }}</td>
												<td>{{ pay.graduity }}</td>
												<td>{{ pay.mediclaim }}</td>
												<td>{{ pay.gradeGrossSalary }}</td>
												<td>{{ pay.gradeNetSalary }}</td>
